...
import club.boyuan.official.common.converter.PermissionConverter;
...
import club.boyuan.official.persistence.mapper.PermissionMapper;
import club.boyuan.official.domain.user.service.PermissionService;
...
public class PermissionServiceImpl extends ServiceImpl<PermissionMapper, Permission> implements PermissionService {
    ...
    public PermissionDTO updatePermission(PermissionDTO permissionDTO) throws BusinessException {
        ...
        return permissionConverter.toDto(updatedPermission);
    }
    ...
    public List<PermissionDTO> getPermissions(String resourceIdentifier, String keyword, int page, int size, String sort) throws BusinessException {
        ...
        // 转换实体列表为DTO列表并返回
        return permissionConverter.toDtoList(pageObj.getRecords());
    }

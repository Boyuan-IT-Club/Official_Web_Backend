...
import club.boyuan.official.common.converter.RoleConverter;
...
import club.boyuan.official.persistence.mapper.RolePermissionMapper;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public List<RoleDTO> getRoles(int status, String keyword,
        ...
        // 转换实体列表为DTO列表并返回
        return roleConverter.toDtoList(pageObj.getRecords());
    }

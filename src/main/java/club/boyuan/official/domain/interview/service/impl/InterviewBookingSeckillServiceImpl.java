...
import club.boyuan.official.infra.seckill.*;
import club.boyuan.official.domain.user.service.*;
import club.boyuan.official.domain.resume.service.*;
import club.boyuan.official.domain.interview.service.*;
